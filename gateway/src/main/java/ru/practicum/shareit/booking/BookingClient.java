...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getOwnersBooking(long userId, BookingState state) {
        Map<String, Object> parameters = Map.of(
                "state", state.name()
        );
    ...
    public ResponseEntity<Object> changeBookingRequestStatus(long userId, long bookingId, boolean approved) {
        Map<String, Object> parameters = Map.of(
                    "approved", approved
        );
